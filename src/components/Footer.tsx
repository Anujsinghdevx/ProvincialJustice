      ...
      <div className="h-40   shadow dark:bg-black">
        <footer className=" shadow dark:bg-black ">
          <div className="w-full max-w-screen-xl mx-auto md:py-8">
            ...
            <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="/" className="hover:underline">Provincial Justice™</a>. All Rights Reserved.</span>
          </div>
        </footer>
      </div>
    </div>
